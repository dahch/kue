...
| 4      | Overlay & UI        | Transparent window, always-on-top, click-through (implemented). React Overlay component with 3s auto-dismiss (implemented). Mic VAD for Shadow-mode hint cancellation (implemented). Practice vs Shadow mode routing (implemented). Channel A batch transcription (implemented — `stt/batch.rs`). **Remaining:** Panic button, mode selection UI, hint positioning.                                                                                                                                                                                                                                                                                                       | 🔶 Partial (70%) |
